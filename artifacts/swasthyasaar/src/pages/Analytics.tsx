...
export default function Analytics() {
  const pieData = [
    { name: 'Critical', value: 4, color: 'hsl(357 77% 56%)' }, // Destructive
    { name: 'High', value: 6, color: 'hsl(38 90% 55%)' }, // Secondary
    { name: 'Medium', value: 9, color: 'hsl(210 100% 50%)' }, // Blue
    { name: 'Low', value: 12, color: 'hsl(136 63% 47%)' }, // Success
  ];
