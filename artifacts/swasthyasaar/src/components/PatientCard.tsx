...
export function PatientCard({ patient }: PatientCardProps) {
  return (
    <Link href={`/patient/${patient.id}`}>
      <Card className="p-4 hover-lift cursor-pointer active-scale bg-card hover:bg-muted/50 transition-colors border-border shadow-sm" data-testid={`card-patient-${patient.id}`}>
